...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference("History.count") do
      post histories_url, params: { history: { release_train_id: @history.release_train_id, run_result: @history.run_result, version: @history.version } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { release_train_id: @history.release_train_id, run_result: @history.run_result, version: @history.version } }
